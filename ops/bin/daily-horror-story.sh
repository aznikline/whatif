...
- 允许吸收“宇宙冷怖/不可名状”的高层方法：不要急着给怪东西命名；让人先感到尺度、角度、气味、时间或知识出了偏差；让主角意识到自己只看见了一角。
- 但不要偷懒写成“无法名状”“不可描述”这种空话。必须把不可名状落实成可见副作用：物理感受、职业异常、记录残缺、测量失真、命名失败、影子不守规矩、气味先到。
- 不要直接堆古神、触手、深渊、星辰、疯狂这些现成词做廉价氛围。真正可怕的是人类分类法失效，而主角还得继续工作。
- 不要照搬任何在世作者的句法和口吻。
