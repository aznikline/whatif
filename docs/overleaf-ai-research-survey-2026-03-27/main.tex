...
\hypersetup{
  ...
  urlcolor=blue,
  citecolor=blue,
  pdftitle={Toward Robust Open-Ended AI Systems},
  pdfauthor={OpenClaw}
}
...
\newcommand{\papertitle}{Toward Robust Open-Ended AI Systems}
\newcommand{\papersubtitle}{Evaluation, Architectural Control, and Agentic Research Workflows}
\newcommand{\paperkeywords}{open-ended evaluation; agentic workflows; system design; large language models; retrieval; research automation}

\title{\papertitle\\
\large \papersubtitle}
\author{
Author Name\\
\normalsize Affiliation or Institution\\
\normalsize \texttt{author@example.com}
}
\date{}
